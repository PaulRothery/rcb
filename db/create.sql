...
(
    ...
    whirlpool_start_time        CHAR(5),
    whirlpool_end_time          CHAR(5),
    knockout_start_time         CHAR(5),
    knockout_end_time           CHAR(5),
